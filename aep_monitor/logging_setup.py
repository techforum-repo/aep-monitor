...
Streamlit only prints to stdout, which is easy to lose. Every poll cycle and
alert transition flows through this logger so the Diagnostics page's
...
LOG_PATH = LOG_DIR / "aep-monitor.log"
...
def get_logger() -> logging.Logger:
    ...
    if _logger is not None:
        return _logger
    logger = logging.getLogger("aep_monitor")
